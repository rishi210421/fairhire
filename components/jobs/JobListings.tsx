...
export default function JobListings({ jobs: initialJobs, applications, student }: JobListingsProps) {
    ...
    <div>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        {initialJobs.map((job) => {
          ...
          const applicationCount = (job as any).application_count || 0;
          const isFull = applicationCount >= job.applicant_limit;
          const canApply = !alreadyApplied && !deadlinePassed && !isFull && 
              ...
              <div className="mb-4">
                <div className="flex flex-wrap gap-2">
                  ...
                  {job.skills_required.length > 5 && (
                    <span className="text-gray-500 text-xs">+{job.skills_required.length - 5} more</span>
                  )}
                </div>
              </div>
